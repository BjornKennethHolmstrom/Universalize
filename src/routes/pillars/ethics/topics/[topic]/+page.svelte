<!-- src/routes/pillars/ethics/topics/[topic]/+page.svelte -->
<script lang="ts">
...
<SEO
  ...
  description={metadata?.description || 'Explore universal ethics and cosmic perspective.'}
  keywords={metadata?.keywords || 'universal perspective, ethics, cosmic consciousness'}
  type="article"
  section="Universal Ethics"
/>
...
<article class="min-h-screen bg-slate-900">
  ...
  <section class="border-t border-slate-800 bg-slate-950 px-6 py-12">
    <div class="mx-auto max-w-4xl">
      ...
      >
        <span>←</span>
        <span>{$currentLanguage === 'sv' ? 'Tillbaka till universell etik' : 'Back to Universal Ethics'}</span>
      </a>
    </div>
  </section>
  ...
  <section class="bg-slate-900 px-6">
    <div class="mx-auto max-w-4xl">
      <ShareButtons 
        title={metadata?.title || 'Universal Ethics'}
